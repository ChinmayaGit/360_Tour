...
infoThree.addEventListener('click', function() {
  var popupBox = document.createElement('div');
  popupBox.innerHTML = 'This is the popup box.';
  popupBox.style.position = 'absolute';
  popupBox.style.top = '50%';
  popupBox.style.left = '50%';
  popupBox.style.transform = 'translate(-50%, -50%)';
  viewer.container.appendChild(popupBox);
});
// infoFour=infoButton("Broken Socket", 5500, 0000, -0000);
infoFive = new PANOLENS.GoogleStreetviewPanorama( 'rY5ZW6S3sFUAAAAGOzOdpg' );
infoFive=infoButton("Video", -5000.00, -1825.25, 197.56);
